 ...
 */
export function createConnectHandler({ config, accountManager, ensureLeaf, logDir = null, hooks = {}, log = () => {}, sx = null, provenance = null }) {
  ...
  const getServer = (pin = '') => {
    ...
    srv.on('request', createProxyRequestListener({ accountManager, upstream, logDir, hooks, sx, holdMs, config, forcedPin: pin || null, provenance, listenerTag: 'm' }));
